...
namespace Test {
    ...
    public class Test2 : MonoBehaviour
    {
        ...
        private NativeColorMesh resultMesh;
        private Mesh mesh;
        ...
        private void Start() {
            ...
            mesh.MarkDynamic();
            resultMesh = new NativeColorMesh(256, Allocator.Persistent);
            StartJob();
        }
        ...
        private void StartJob() {
            resultMesh.Clear();
            var generateMeshJob = new GenerateMeshJobTest2 {
                time = Time.time,
                result = resultMesh
            }; 
    ...
    [BurstCompile]
    public struct GenerateMeshJobTest2 : IJob {
        [ReadOnly]
        public float time;

        public NativeColorMesh result;
        ...
        public void Execute() {
            ...
            for (float x = -w; x < w; x += 1f) {
                for (float y = -h; y < h; y += 1f) {
                    ...
                    result.AddAndDispose(starMesh, Color.yellow);            
                }   
            }
        }
    }
